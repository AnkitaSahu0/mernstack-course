...
export default function Hero() {
  ...
  {/* UPDATED: py-12 ko pt-4 pb-6 kiya taaki unnecessary height kam ho sake */}
  <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 pt-6 pb-6">
        {/* Left Content Column */}
        <div className="lg:col-span-7 space-y-6 text-left">
          {/* Top Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100 dark:bg-[#0b1524] border border-zinc-200 dark:border-sky-500/20 text-[#25a0e2] text-xs sm:text-sm font-medium tracking-wide transition-colors">
            🚀 The Ultimate MERN Stack Course
          </div>

          {/* Heading */}
          <h1 className="text-4xl sm:text-5xl xl:text-6xl font-black text-zinc-900 dark:text-zinc-200 tracking-tight leading-[1.15] transition-colors">
            Become a <span className="bg-gradient-to-r from-[#25a0e2] to-[#4f46e5] bg-clip-text text-transparent">MERN <br className="hidden sm:block"/>Stack</span> Developer
          </h1>

          {/* Description */}
          <p className="text-zinc-600 dark:text-zinc-400 text-base sm:text-lg max-w-xl leading-relaxed transition-colors">
            Learn React, Node.js, Express.js and MongoDB from scratch. Build production-ready full-stack applications.
          </p>
      ...
      <div className="flex flex-wrap items-center gap-4 pt-2">
        ...
        <button 
          ...
          className="px-8 py-3.5 bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-700 hover:to-sky-600 text-white font-bold rounded-full shadow-lg shadow-blue-500/20 transition-all cursor-pointer active:scale-95"
        >
          Enroll Now
        </button>
        ...
        <button 
          ...
          className="px-6 py-3.5 bg-zinc-100 dark:bg-[#0b1524] hover:bg-zinc-200 dark:hover:bg-[#112035] text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-800 font-semibold rounded-full flex items-center gap-2 transition-all cursor-pointer active:scale-95"
        >
      ...
      {/* ================= CUSTOM THEME UI POPUP (MODAL) ================= */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          
          {/* Backdrop (Background blur aur dark overlay) */}
          <div 
          ...
          {/* Modal Box */}
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-zinc-50 dark:bg-[#0b1524] border border-zinc-200 dark:border-zinc-800/80 p-6 sm:p-8 shadow-2xl transform transition-all scale-100 animate-in fade-in zoom-in-95 duration-200">
            
            {/* Close Button Cross */}
            <button 
              onClick={() => setIsModalOpen(false)}
              className="absolute right-4 top-4 p-1 rounded-full text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-800/60 transition-colors"
            >
              <X size={18} />
            </button>
            ...
            <div className="text-center space-y-4 mt-2">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-black text-zinc-900 dark:text-white tracking-tight">
                  Proceed to <span className="text-[#25a0e2]">Registration</span>
                </h3>
                <p className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm leading-relaxed">
                  Aapko application form section par redirect kiya ja raha hai. Kripya apni details sahi se fill karein.
                </p>
              </div>

              {/* Action Button (OK ki jagah professional button) */}
              <button 
                onClick={handleProceedToForm}
                className="w-full mt-4 py-3 px-4 inline-flex items-center justify-center gap-2 rounded-xl text-sm font-bold bg-gradient-to-r from-[#25a0e2] to-[#4f46e5] text-white shadow-lg shadow-blue-500/10 hover:opacity-95 transition-all active:scale-[0.98]"
              >
          ...
          {/* Student Stats Avatars */}
          <div className="flex items-center gap-3 pt-6  border-zinc-200 dark:border-zinc-900/60">
            <div className="flex -space-x-3 overflow-hidden">
              {[
                "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80",
                "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80",
        ...
        {/* Right Animated Graphics Column */}
<div className="lg:col-span-5 flex justify-center items-center relative h-[450px] w-full select-none">
  
  {/* Dotted/Dashed Orbiting Ring Axis */}
  <div className="relative w-80 h-80 rounded-full border-2 border-dashed border-zinc-300/40 dark:border-zinc-800/60 flex items-center justify-center animate-[spin_40s_linear_infinite]">
    
    {/* 🍃 MongoDB (Top Left) - LARGER SIZE */}
    <div className="absolute top-4 left-4 -translate-x-1/2 -translate-y-1/2 p-4 rounded-2xl bg-zinc-50 dark:bg-[#0f1b2d] border border-zinc-200 dark:border-zinc-800/80 shadow-2xl shadow-emerald-500/[0.05] animate-[spin_40s_linear_infinite_reverse]">
    ...
    {/* ex Express.js (Top Right) - LARGER SIZE */}
    <div className="absolute top-4 right-4 translate-x-1/2 -translate-y-1/2 p-4 rounded-2xl bg-zinc-50 dark:bg-[#0f1b2d] border border-zinc-200 dark:border-zinc-800/80 shadow-2xl animate-[spin_40s_linear_infinite_reverse]">
      <span className="text-2xl font-normal tracking-tighter text-zinc-800 dark:text-zinc-200 font-sans px-1.5 block leading-none select-none">ex</span>
    </div>

    {/* ⚛️ React (Bottom Right) - LARGER SIZE */}
    <div className="absolute bottom-4 right-4 translate-x-1/2 translate-y-1/2 p-4 rounded-2xl bg-zinc-50 dark:bg-[#0f1b2d] border border-zinc-200 dark:border-zinc-800/80 shadow-2xl shadow-sky-500/[0.05] animate-[spin_40s_linear_infinite_reverse]">
      <svg className="w-8 h-8 text-[#61dafb] animate-[spin_10s_linear_infinite]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {/* 🟢 Node.js (Bottom Left) - LARGER SIZE */}
    <div className="absolute bottom-4 left-4 -translate-x-1/2 translate-y-1/2 p-4 rounded-2xl bg-zinc-50 dark:bg-[#0f1b2d] border border-zinc-200 dark:border-zinc-800/80 shadow-2xl shadow-green-500/[0.05] animate-[spin_40s_linear_infinite_reverse]">
  ...
  {/* Center Main Core */}
  <div className="absolute w-28 h-28 rounded-full bg-blue-500/10 dark:bg-blue-500/5 flex items-center justify-center border border-blue-500/10 backdrop-blur-sm animate-pulse">
    <div className="w-16 h-16 rounded-full bg-gradient-to-b from-[#25a0e2] to-blue-600 shadow-[0_0_40px_rgba(37,160,226,0.6)]" />
  </div>
